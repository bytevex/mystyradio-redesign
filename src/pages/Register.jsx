        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Nieuw Account</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              <span className="gradient-text">Registreren</span>
            </h1>
            <p className="text-lg text-muted max-w-2xl mx-auto">
              Word onderdeel van de Misty Radio community
            </p>
          </motion.div>
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted max-w-xl">
                  Registraties zijn momenteel uitgeschakeld wegens uitbreidingen aan het platform.
